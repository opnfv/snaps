...
+---------------------------------------+---------------+-----------------------------------------------------------+
| test_add_volume_nowait                | 2             | Ensures that a VM instance can properly attach and detach |
|                                       |               | a volume using the nova interface without waiting for the |
|                                       |               | update to fully occur                                     |
+---------------------------------------+---------------+-----------------------------------------------------------+
