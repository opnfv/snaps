...
class CreateMultiPartImageTests(OSIntegrationTestCase):
    ...
    def test_create_three_part_image_from_file(self):
        ...
        if self.image_metadata and
            'kernel_url' in self.image_metadata and self.image_metadata['kernel_url']:
        ...
        if self.image_metadata and
            'ramdisk_url' in self.image_metadata and self.image_metadata['ramdisk_url']:
