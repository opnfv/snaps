...
class ImageSettings:
    def __init__(self, config=None, name=None, image_user=None, img_format=None, url=None, image_file=None,
                 parts=1, kernel=None, ramdisk=None, extra_properties=None, nic_config_pb_loc=None):
        """
        ...
        :param parts: if this is an one-part image or a three-part image; default is one-part image
        ...
        if self.parts is 3 and not (self.kernel or self.ramdisk):
            raise Exception('Please set kernel and ramdisk locations for the three-part image')
